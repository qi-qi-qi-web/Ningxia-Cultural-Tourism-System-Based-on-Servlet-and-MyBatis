...
<body>
    ...
    <script>
		...
		<div id="search">
            <div id="login">
                <div style="text-align: center;"><span id="login_header1">登录</span><b>·</b><span id="login_header" onclick="jump_1()">注册</span></div>
                <form action="login" method="post">
                    <div><input class="input" placeholder="手机号或邮箱" type="text" name="phoneOrEmail" style="margin: 0px 40 0px; border-radius: 0px 0px 0px 0px;"></div>
                    ...
                    <div class=""><button class="button_1" type="submit" style="margin-top: 20%;">登  录</button></div>
                </form>
            </div>
        </div>
</body>
