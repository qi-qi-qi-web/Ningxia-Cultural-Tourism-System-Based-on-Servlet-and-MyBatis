                ...
                <div class="col-lg-4 col-sm-6">
                    <article class="card-classic" style="display:flex;flex-direction:column;height:100%;">
                        ...
                        <div class="card-classic__actions" style="margin-top:auto;"><a class="button button-primary-2 button-md" href="Hotel-detail.jsp?id=${h.id}">了解更多</a>
                            <span style="cursor:pointer;font-size:14px;color:#999;font-style:normal;" onclick="toggleFavHotel(${h.id}, this)"><span class="icon fa fa-heart fav-heart" style="color:#ccc;margin-right:4px;"></span><span class="fav-cnt">${h.favoriteCount}</span> 收藏</span>
