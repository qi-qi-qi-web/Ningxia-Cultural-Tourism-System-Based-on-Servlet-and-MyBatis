...
<div id="edit-modal" style="display:none;position:fixed;z-index:2000;left:0;top:0;width:100%;height:100%;background:rgba(0,0,0,0.5);">
    <div style="background:#fff;border-radius:8px;max-width:650px;margin:5% auto;padding:25px;max-height:80vh;overflow-y:auto;">
        ...
        <form method="post" action="${pageContext.request.contextPath}/admin/scenic">
            ...
            <div class="mb-2"><label>封面图URL</label><input class="form-control" name="coverImage" id="s-cover"></div>
            <div class="mb-3"><label>图片列表(JSON)</label><input class="form-control" name="images" id="s-imgs" placeholder='["url1","url2"]'></div>
